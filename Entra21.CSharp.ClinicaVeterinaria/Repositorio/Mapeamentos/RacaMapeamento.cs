...
{
    // DB First: Criar uma aplicacao onde o banco de dados existente
    // Code First: Criar um banco de dados apartir de uma aplicacao existente
    // Seed: Alimentar o canco de dads com registros
    ...
    internal class RacaMapeamento : IEntityTypeConfiguration<Raca>
    {
        public void Configure(EntityTypeBuilder<Raca> builder)
        {
            ...
            // Populando a tabela de raca com dois regitros
            builder.HasData(
                new Raca
                {
                    Id = 1,
